...
const (
	...
	apiSpecialOrganizationMemberManager = "/organization/%s/member/manager"

	apiDepartment                     = "/department"
	apiSpecialDepartment              = "/department/%s"
	apiSpecialDepartmentMember        = "/department/%s/member"
	apiSpecialDepartmentMemberBind    = "/department/%s/member/bind"
	apiSpecialDepartmentMemberUnbind  = "/department/%s/member/unbind"
	apiSpecialDepartmentMemberManager = "/department/%s/member/manager"
)
